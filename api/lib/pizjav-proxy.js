  ...
  app.get('/api/pizjav-proxy', async (req, res) => {
    ...
    try {
      ...
      <style id="vmeda-mobile">
        ...
        iframe[src*="video"],iframe[src*="embed"],iframe[src*="player"],iframe[src*="stream"],iframe[src*="phimvu"], [class*="player"] iframe, [id*="player"] iframe, [class*="video"] iframe, [class*="videoWrapper"] iframe { max-width:100% !important; width:100% !important; aspect-ratio:16/9; height:auto !important; min-height:200px !important; max-height:none !important; }
